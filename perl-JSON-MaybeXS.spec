...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/JSON-MaybeXS-1.004004.tar.gz
...
%prep
%setup -q -n JSON-MaybeXS-1.004004
cd %{_builddir}
tar xf %{_sourcedir}/libjson-maybexs-perl_1.004000-1.debian.tar.xz
cd %{_builddir}/JSON-MaybeXS-1.004004
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/JSON-MaybeXS-1.004004/deblicense/
